...
<section class = "grow flex flex-col justify-center items-center" id = "recoverPassword" >
    ...
    <div class = "grow flex items-center justify-center">
        ...
        <form id = "recoveryToken" class = "hidden flex-col max-w-xl grid-start-1 bg-slate-100 shadow-md rounded px-8 pt-6 pb-8 my-4" >
            <p class="mb-4">Please insert the token that was sent to you by email</p>
            ...
            <button onclick = "tokenCheck()" type="button" class="self-center bg-sky-800 rounded w-32 py-2  text-white font-bold shadow shadow-sky-900 hover:shadow-lg">Verify</button>
        </form>
