<div id = "navigation-menu" class= "transition-w ease-in duration-300 flex justify-items-center flex-col w-1/5 max-w-80 bg-sky-900 p-4 text-white text-nowrap">
    <header class = "flex items-center justify-between overflow-hidden">
            <h1 class = "text-xl font-bold">
                <a href="{{ url('/home') }}" ><span>Wavy</span></a>
            </h1>
            <button class="mr-2" onclick = "navigationMenuOperation()">
