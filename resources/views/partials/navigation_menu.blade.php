<div id = "navigation-menu" class= "flex justify-items-center flex-row lg:flex-col lg:w-52 w-screen lg:max-h-screen bg-sky-900 py-4 md:p-4 text-white text-nowrap fixed bottom-0 lg:top-0 transition-w ease-in duration-300 z-10 border-r border-gray-300">
    <header class = "lg:flex items-center justify-between overflow-hidden">
            <h1 class = "text-xl font-bold">
                <a href="{{ url('/home') }}" >
                    <span class="hidden lg:block">Wavy</span>
                </a>
            </h1>
    </header>
    <nav class = "grow lg:pt-14">
        <ul class = "flex lg:justify-center flex-row lg:flex-col justify-evenly md:gap-12 overflow-scroll">
