<aside class = "flex fixed lg:sticky top-0 right-0 w-60 bottom-12 max-h-screen transition-all ease-in duration-300" id = "context-menu">
    <button class = "absolute right-56 z-10 top-2 bg-sky-950 shadow rounded-3xl p-2 transition-all ease-in duration-300 overflow-scroll" onclick = "contextMenuOperation()">
