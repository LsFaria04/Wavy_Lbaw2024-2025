<aside class = "flex fixed lg:sticky top-0 right-0 w-0 bottom-12 max-h-screen transition-all ease-in duration-300 z-10" id = "context-menu">
    <button class = "absolute right-56 top-2 translate-x-56 bg-sky-950 shadow rounded-3xl p-2 transition-all ease-in duration-300 overflow-scroll rotate-180" onclick = "contextMenuOperation()">
